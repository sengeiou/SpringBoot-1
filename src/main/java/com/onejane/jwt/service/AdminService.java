package com.onejane.jwt.service;

import com.onejane.jwt.dao.AdminDao;
import com.onejane.jwt.entity.Admin;
import com.onejane.jwt.utils.IdWorker;
...
public class AdminService {
	...
	public Admin findById(String id) {
		return adminDao.findOne(Example.of(Admin.builder().id(id).build())).get();
	}
	...
	public void deleteById(String id) {
		adminDao.delete(Admin.builder().id(id).build());
	}
